...
namespace Oss4u.Youtrack
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/oss4u/pulumi-youtrack-native";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Oss4u.Youtrack.version.txt");
    ...
    internal sealed class YoutrackResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public YoutrackResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
