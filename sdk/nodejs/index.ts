...
pulumi.runtime.registerResourceModule("youtrack", "index", _module)
pulumi.runtime.registerResourcePackage("youtrack", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:youtrack") {
